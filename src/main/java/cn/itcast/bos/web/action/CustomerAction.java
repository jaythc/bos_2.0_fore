	...
	public String activeEmail() throws IOException {
		...
		if (activeCodeRedis != null && activeCodeRedis.equals(activeCode)) {
			...
			Customer customer = WebClient
					.create("http://localhost:9011/crm_management/services/customerService/customer/telephone/"
							+ model.getTelephone())
			...
			if (customer != null) {
				if (customer.getType()!=null && customer.getType() == 1) {
					...
					// 没有绑定邮箱, 进行绑定
					WebClient
							.create("http://localhost:9011/crm_management/services/customerService/customer/updatetype/"
									+ model.getTelephone())
							.put(null);
